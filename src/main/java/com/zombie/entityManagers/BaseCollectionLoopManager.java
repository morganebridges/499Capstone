//TODO : figure out a good way to do code reuse for this. I was thinking need to think about it later when I'm not as dumb.
...
public class BaseCollectionLoopManager {
    @Autowired
